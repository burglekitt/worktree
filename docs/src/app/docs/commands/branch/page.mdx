...
1. `burglekitt.worktree.jira.host` - Your Jira workspace URL (e.g., `https://company.atlassian.net`)
2. `burglekitt.worktree.jira.email` - Your Jira email address
3. `burglekitt.worktree.jira.apiToken` - Your Jira API token
