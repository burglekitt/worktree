...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tabs.Tab>
    <TerminalBlock>npm install -g @burglekitt/worktree</TerminalBlock>
  </Tabs.Tab>
  <Tabs.Tab>
    <TerminalBlock>pnpm add -g @burglekitt/worktree</TerminalBlock>
  </Tabs.Tab>
  <Tabs.Tab>
    <TerminalBlock>yarn global add @burglekitt/worktree</TerminalBlock>
  </Tabs.Tab>
  <Tabs.Tab>
    <TerminalBlock>bun add -g @burglekitt/worktree</TerminalBlock>
  </Tabs.Tab>
</Tabs>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tabs.Tab>
    <TerminalBlock>npx @burglekitt/worktree --help</TerminalBlock>
  </Tabs.Tab>
  <Tabs.Tab>
    <TerminalBlock>pnpm dlx @burglekitt/worktree --help</TerminalBlock>
  </Tabs.Tab>
  <Tabs.Tab>
    <TerminalBlock>yarn dlx @burglekitt/worktree --help</TerminalBlock>
  </Tabs.Tab>
  <Tabs.Tab>
    <TerminalBlock>bunx @burglekitt/worktree --help</TerminalBlock>
  </Tabs.Tab>
</Tabs>
