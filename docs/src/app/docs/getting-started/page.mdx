...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tabs.Tab>```bash npm install -g @burglekitt/worktree ```</Tabs.Tab>
  <Tabs.Tab>```bash pnpm add -g @burglekitt/worktree ```</Tabs.Tab>
  <Tabs.Tab>```bash yarn global add @burglekitt/worktree ```</Tabs.Tab>
  <Tabs.Tab>```bash bun add -g @burglekitt/worktree ```</Tabs.Tab>
</Tabs>

Or run directly without global install:

<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tabs.Tab>```bash npx @burglekitt/worktree --help ```</Tabs.Tab>
  <Tabs.Tab>```bash pnpm dlx @burglekitt/worktree --help ```</Tabs.Tab>
  <Tabs.Tab>```bash yarn dlx @burglekitt/worktree --help ```</Tabs.Tab>
  <Tabs.Tab>```bash bunx @burglekitt/worktree --help ```</Tabs.Tab>
</Tabs>
